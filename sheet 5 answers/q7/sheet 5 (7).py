class Point2D:
    def __init__(self, x=0, y=0): #define initializes a new point 2D  x=0,y=0 => default values
        self.x = x
        self.y = y
...
#__str__ to make it easy to appear in coordinates
    ...
    def add(self, p):
        self.x += p.x
        self.y += p.y
#adds the coordinates of p2(self.x,self.y) in this example to the current point p1 (p.x,p.y)
...
p2.add(p1) #add point 2 to point 1  # p2=(4+1,2+-2) = (5,0)     new p2
